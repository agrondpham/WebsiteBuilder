...
insert into items (name,description,image,image_type,type_id) values ('logo','logo of quanchaythaotam','/WebsiteBuilder/assets/images/logo.png','2',1)
insert into items (name,description,image,image_type,type_id) values ('logo2','logo2 of quanchaythaotam','/WebsiteBuilder//assets/images/logo_2.png','1',2)


insert into ftypes (name) values ('smallLogoImage');
insert into ftypes (name) values ('logoImage');
