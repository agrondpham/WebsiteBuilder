...
<html lang="en">
                      ...
                      <section class="panel">
                        ...
                        <table class="table table-hover personal-task">
                              ...
                              <tr>
                                  <td>
                                    <span class="profile-ava">
                                        <img alt="" class="simple" src="${pageContext.request.contextPath}/resources/img/avatar-mini.jpg">
                                    </span>
                                  </td>
                                  <td>
                              ...
                              <tr>
                                  <td>
                                    <span class="profile-ava">
                                        <img alt="" class="simple" src="${pageContext.request.contextPath}/resources/img/avatar-mini2.jpg">
                                    </span>
                                  </td>
                                  <td>
                              ...
                              <tr>
                                  <td>
                                    <span class="profile-ava">
                                        <img alt="" class="simple" src="${pageContext.request.contextPath}/resources/img/avatar-mini3.jpg">
                                    </span>
                                  </td>
                                  <td>
                              ...
                              <tr>
                                  <td>
                                    <span class="profile-ava">
                                        <img alt="" class="simple" src="${pageContext.request.contextPath}/resources/img/avatar-mini4.jpg">
                                    </span>
                                  </td>
                                  <td>
  ...
  <!-- container section start -->
    ...
    <script src="${pageContext.request.contextPath}/resources/assets/fullcalendar/fullcalendar/fullcalendar.min.js"></script>
